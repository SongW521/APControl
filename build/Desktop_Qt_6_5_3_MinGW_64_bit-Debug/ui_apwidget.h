...
public:
    ...
    void setupUi(QWidget *APWidget)
    {
        ...
        layoutWidget2->setGeometry(QRect(10, 34, 501, 167));
        ...
        realRangeLE_2 = new QLineEdit(layoutWidget2);
...
"background-color: rgb(100, 100, 100);"));
        ...
        inputRangeCB_1 = new QComboBox(layoutWidget2);
        ...
        inputRangeCB_2 = new QComboBox(layoutWidget2);
        ...
        inputTypeCB_2 = new QComboBox(layoutWidget2);
        ...
        realRangeLE_1 = new QLineEdit(layoutWidget2);
...
"background-color: rgb(100, 100, 100);"));
        ...
        inputTypeCB_1 = new QComboBox(layoutWidget2);
        ...
        setInputBT = new QPushButton(groupBox);
        setInputBT->setObjectName("setInputBT");
        setInputBT->setGeometry(QRect(540, 170, 100, 30));
        ...
        layoutWidget3->setGeometry(QRect(11, 31, 501, 95));
        ...
        outputTypeCB_1 = new QComboBox(layoutWidget3);
        ...
        outputTypeCB_2 = new QComboBox(layoutWidget3);
        ...
        outputRangeCB_1 = new QComboBox(layoutWidget3);
        ...
        outputRangeCB_2 = new QComboBox(layoutWidget3);
        ...
        layoutWidget4 = new QWidget(APWidget);
        layoutWidget4->setObjectName("layoutWidget4");
        layoutWidget4->setGeometry(QRect(18, 11, 651, 32));
        horizontalLayout = new QHBoxLayout(layoutWidget4);
        horizontalLayout->setObjectName("horizontalLayout");
        horizontalLayout->setContentsMargins(0, 0, 0, 0);
        linkBT = new QPushButton(layoutWidget4);
        ...
        devSecCB = new QComboBox(layoutWidget4);
        devSecCB->addItem(QString());
        devSecCB->addItem(QString());
        devSecCB->setObjectName("devSecCB");
        devSecCB->setEnabled(false);
...
""));
        ...
        devIDLE = new QLineEdit(layoutWidget4);
...
"background-color: rgb(79, 79, 79);"));
        ...
        exitBT = new QPushButton(layoutWidget4);
